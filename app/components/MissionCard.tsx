  ...
  return (
    <>
      ...
      <div className="relative z-10 -mb-16 flex flex-col md:flex-row justify-center items-stretch gap-8 px-4">
        <div className="backdrop-blur-md bg-white/10 border-2 border-gray-400 text-gray-800 shadow-lg rounded-xl p-8 md:w-1/2  ">
      ...
      <div className="bg-blue-600 text-white py-24 px-4 mt-0 rounded-md">
